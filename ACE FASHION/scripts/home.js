...
async function countData() {
  let res = await fetch(`https://63f47ff055677ef68bbd4bb4.mockapi.io/products?search=${searchinp}`)
...
async function fetchData(pagenumber, api) {
  let res = await fetch(`https://63f47ff055677ef68bbd4bb4.mockapi.io/products?search=${searchinp}&page=${pagenumber}&limit=12`)
  let data = await res.json()
  // data = data.data
  console.log(data)
  arr = [...data]
